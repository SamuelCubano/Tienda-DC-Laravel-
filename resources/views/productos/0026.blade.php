...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0026.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Zapatillas Manteca 4 Mid (Whk) Dc Mujer</h2>
      <p><strong>Precio: </strong><span class="precio-actual">$134,99 </span></p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>COMPOSICIÓN Empeine: Piel (Vaca) / Forro: Textil / Suela: Goma <br>

•Capellada cuero nobuk o gamuza.<br>
•Cuello y lengüeta cómodos, acolchados con espuma Comfort.<br>
•Correas para centrar la lengüeta.<br>
•Tejido interior de malla, mayor confort.<br>
•Logo en el lateral.<br>
•Interior envolvente EVA.<br>
•Suela exterior de caucho goma adherente resistente a la abrasión.<br>
•Pisada con dibujo "Pill Pattern" marca registrada DC.</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Zapatillas Manteca 4 Mid (Whk) Dc Mujer', 134.99)">Agregar al carrito</button>
    </div>
  </div>
