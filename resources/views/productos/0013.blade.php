...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0013.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Musculosa DC Magic Eye (Neg) DC Mujer</h2>
      <p><strong>Precio: </strong><span class="precio-actual">$14,78 </span></p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>TELA 100% Algodon Musculosa Tejido: Jersey 24.1 Fit: Regular Estampa en el frente Avios DC</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Musculosa DC Magic Eye (Neg) DC Mujer', 14.78)">Agregar al carrito</button>
    </div>
  </div>
