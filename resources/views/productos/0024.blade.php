...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0024.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Zapatillas Manteca V Ss (Owm) Dc Mujer</h2>
      <p><strong>Precio: </strong><span class="precio-actual">$143,43 </span></p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>COMPOSICIÓN Empeine: Piel (Vaca) / Forro: Textil / Suela: Goma <br>

•Capellada de Sintético o descarne y/o textil<br>
•Ajuste con velcro<br>
•Forreria liviana en lengüeta.<br>
•Cuello y lengueta con espuma acolchada para máximo confort y soporte.<br>
•Diseño Pill Pattern de DC en pisada<br>
•Suela Cupsole de caucho resistente a la abrasión con costura alrededor, proveyendo mayor durabilidad y resistencia.</p>
      <p><strong>COLOR: AMARILLO </strong></p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Zapatillas Manteca V Ss (Own) Dc Mujer', 143.43)">Agregar al carrito</button>
    </div>
  </div>
