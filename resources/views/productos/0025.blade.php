...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0025.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Zapatillas Manteca 4 Platform (Bkw) Dc Mujer</h2>
      <p><strong>Precio: </strong><span class="precio-actual">$134,99 </span></p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>COMPOSICIÓN Empeine: Piel (Vaca) / Forro: Textil / Suela: EVA <br>

•Capellada cuero<br>

•Lengüeta y cuello acolchados con espuma para mayor confort y sujeción<br>

•Construcción de suela con plataformat<br>
<br>

•Suela exterior de EVA<br>
...
•Pisada con dibujo "Pill Pattern" marca registrada DC</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Zapatillas Manteca 4 Platform (Bkw) Dc Mujer', 134.99)">Agregar al carrito</button>
    </div>
  </div>
