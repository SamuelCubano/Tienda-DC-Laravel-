...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0015.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Buzo Life Changes (Hue) DC Mujer</h2>
      <p><strong>Precio: </strong><span class="precio-actual">$67,55 </span></p>
...
Avios DC</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Buzo Life Changes (Hue) DC Mujer', 67.55)">Agregar al carrito</button>
    </div>
  </div>
