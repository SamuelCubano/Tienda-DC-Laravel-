...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0029.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Hat Buffy Solid (Bla) DC Mujer</h2>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Hat Buffy Solid (Bla) DC Mujer', 37.97)">Agregar al carrito</button>
    </div>
  </div>
