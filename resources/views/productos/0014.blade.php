...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0014.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Remera Mc Star Flame Boyfriend (Azf) DC Mujer</h2>
      <p><strong>Precio: </strong><span class="precio-actual">$27,86 </span></p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>TELA 100% Algodón <br>

• Remera manga corta <br>
• Tejido: Jersey 30.1 <br>
• Estampa en el frente <br>
• Fit: Boyfriend<br>
• Avios DC</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Remera Mc Star Flame Boyfriend (Azf) DC Mujer', 27.86)">Agregar al carrito</button>
    </div>
  </div>
