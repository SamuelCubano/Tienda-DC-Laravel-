...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0018.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Beanie Snow Splendid (Neg) DC Mujer</h2>
...
Avios DC</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Beanie Snow Splendid (Neg) DC Mujer', 33.78)">Agregar al carrito</button>
    </div>
  </div>
