...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0011.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Remera Ml DC Op Crest (Azf) DC Mujer</h2>
...
Tela: 100% Algodón</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Remera Ml DC Op Crest (Azf) DC Mujer', 14.78)">Agregar al carrito</button>
    </div>
  </div>
