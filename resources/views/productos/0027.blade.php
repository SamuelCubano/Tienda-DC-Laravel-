...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0027.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Buzo Life Changes (Neg) DC Mujer</h2>
      <p><strong>Precio: </strong><span class="precio-actual">$67,50 </span></p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>TELA 100% Algodon <br>

Buzo cuello redondo <br>
Tejido: Frisa  <br>
Fit: Oversize <br>
...
Avios DC</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Buzo Life Changes (Neg) DC Mujer', 67.50)">Agregar al carrito</button>
    </div>
  </div>
