...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0010.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Remera ML Drip (Ros) DC Mujer</h2>
      <p><strong>Precio: </strong><span class="precio-actual">$379,98 </span></p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>TELA: <br>
WEATHER DEFENSE 10 (10.000mm, 5.000g)<br>
100% Poliéster Reciclado
CALIDEZ Y FORRO:
Aislación PRIMALOFT™ cuerpo 80g y mangas 40g
Forro con tafeta reciclada 60%
Ventilación de axila con forro en mesh.
CARACTERÍSTICAS DEL PRODUCTO:<br>
C0 DWR,
Costuras crìticas selladas,
Cintura fija con revestimiento DWR,
Capucha con ajuste de 2 vías,
Sistema de conexion de la campera al pantalón,
Puño interior de Lycra,
Bolsillos calentadores de manos con cierre,
Bolsillo para pase en manga,
Bolsillo Napoleon con cierre,
...
Producto Importado</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Remera ML Drip (Ros) DC Mujer', 379.98)">Agregar al carrito</button>
    </div>
  </div>
