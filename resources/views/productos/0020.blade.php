...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0020.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Beanie Snow Splendid (Vio) DC Mujer</h2>
      <p><strong>Precio: </strong><span class="precio-actual">$33,78 </span></p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>TEJIDO: Acrílico <br>
Beanie con pompón y doblez <br>
Punto fantasía <br>
Bincha interior en polar<br>
Avios DC</p>
      <p><strong>COLOR: VIOLETA </strong></p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Beanie Snow Splendid (VIO) DC Mujer', 33.78)">Agregar al carrito</button>
    </div>
  </div>
