...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0005.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Zapatillas Pure (Blww) Dc Mujer</h2>
      <p><strong>Precio: </strong>127,04$</p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>COMPOSICIÓN Empeine: Piel (Vaca) / Forro: Textil / Suela: Goma<br>
•Capellada de nobuck sintético, descarne y/o sintético<br> 
•Correas para centrar la lengüeta<br>
•Tejido interior de malla, mayor confort<br>
•Logo bordado en el lateral<br>
•Interior envolvente EVA<br>
•Construcción vulcanizada con suela de caucho resistente a la abrasión.<br>
•Pisada con dibujo "Pill Pattern" marca registrada DC</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Zapatillas Pure (Blww) Dc Mujer', 127.04)">Agregar al carrito</button>
    </div>
  </div>
