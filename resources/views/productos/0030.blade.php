...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0030.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Zapatilla Manteca Ss (Trw) DC Mujer</h2>
      <p><strong>Precio: </strong><span class="precio-actual">$130,77 </span></p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>Capellada de Sintético o Nobuck + Cuello y lengüeta con espuma acolchada para máximo confort y soporte + Diseño Pill Pattern de DC en pisada + Suela Cupsole de caucho resistente a la abrasión con costura alrededor, proveyendo mayor durabilidad y resistencia</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Zapatilla Manteca Ss (Trw) DC Mujer', 130.77)">Agregar al carrito</button>
    </div>
  </div>
