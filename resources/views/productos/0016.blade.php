...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0016.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Zapatillas Midway Sn Knit (Whl) DC Mujer</h2>
      <p><strong>Precio: </strong><span class="precio-actual">$50,66 </span></p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>CARACTERÍSTICAS: <br>

Capellada de Tejido Knit y PU sintético + Refuerzo de puntera
interno para mayor estructura en la parte delantera del pie + Plantilla
ORTHOLITE para mayor amortiguación y protección antimicrobiana +
Suela de EVA de bajo peso.</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Zapatillas Midway Sn Knit (Whl) DC Mujer', 50.66)">Agregar al carrito</button>
    </div>
  </div>
