...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0003.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Campera Navigator Light (Tpc0) DC</h2>
      <p><strong>Precio: </strong>$211,74</p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>TELA 60% Poliéster reciclado, 40% algodón <br>

Campera <br>
Capucha de 3 paneles<br> 
Fit: Regular<br>
Bolsillo ojal a los laterales<br>
Cierre en el frente<br>
Elásticos en cintura y puños<br>
Avios DC<br>

Producto importado</p>
      <p><strong>COLOR: VERDE </strong></p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Campera Navigator Light (Tpc0) DC', 211.74)">Agregar al carrito</button>
    </div>
  </div>
