...
<body onload="checkUserSession(); actualizarCarrito();">
 ...
 <div class="carrito-icono" onclick="toggleCarrito()">
  ...
  <div class="producto-detalle">
    <img src="/img/productos/0006.jpg" alt="Producto">
    <div class="producto-info">
      <h2>Camisa Mc Scribble (Neg) DC</h2>
      <p><strong>Precio: </strong><span class="precio-actual">$85</span> <span class="precio-anterior">$110</span></p>
      <p><strong>Stock disponible:</strong> <span id="stock">10</span></p>
      <p>TELA 100% Algodón Camisa manga corta Tejido: Poplin de algodon Fit: Regular Full print estampa digital Avios DC.</p>
      ...
      <br>
      <button class="btn btn-add" onclick="agregarAlCarrito('Camisa Mc Scribble (Neg) DC', 85)">Agregar al carrito</button>
    </div>
  </div>
  ...
  <main class="grid-productos"> 
    <div class="producto">
      ...
      <a href="producto3.html" class="btn btn-add">Ver más</a>
    </div>
    <div class="producto">
